...
<div class="container">
	...
	<div><button id="btnCheck" type="button" class="btn btn-success btn-lg btnCheck">CHECK</button></div>
	<div><button id="btnCall" type="button" class="btn btn-success btn-lg btnCall">CALL</button></div>
	<div><button id="btnRaise" type="button" class="btn btn-success btn-lg btnRaise">RAISE</button></div>
</div>
