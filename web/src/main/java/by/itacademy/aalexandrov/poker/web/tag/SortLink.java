package by.itacademy.aalexandrov.poker.web.tag;
...
import by.itacademy.aalexandrov.poker.web.dto.grid.SortDTO;
...
public class SortLink extends SimpleTagSupport {
	...
	public void doTag() throws JspException, IOException {
		...
		if (column.equals(sortColumn)) {
			sortIcon = sort.isAscending() ? "<i class=\"fas fa-arrow-down\"></i>" : "<i class=\"fas fa-arrow-up\"></i>";
		} else {
			sortIcon = "";
		}
