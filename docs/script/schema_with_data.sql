...
SELECT pg_catalog.setval('public.card_in_game_id_seq', 20125, true);
...
SELECT pg_catalog.setval('public.game_id_seq', 273, true);
...
SELECT pg_catalog.setval('public.player_id_seq', 655, true);
